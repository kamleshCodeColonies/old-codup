                ...
                <div className="widget-categories-box">
                  ...
                  <div className="widget-categories-menu">
                    <ul>
                      ...
                      <li>
                        <Link legacyBehavior href="/organization/BusinessConsulting">
                          <a
                            onClick={() =>
                              setService({
                                ...service,
                      ...
                      <li>
                        <Link legacyBehavior href="/organization/ManagementConsulting">
                          <a
                            onClick={() =>
                              setService({
                                ...service,
                      ...
                      <li>
                        <Link legacyBehavior href="/organization/ItandSoftwareConsulting">
                          <a
                            onClick={() =>
                              setService({
                                ...service,
